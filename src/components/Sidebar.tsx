      ...
      <div className="pt-4 border-t border-slate-800/80 space-y-2">
        ...
        {userProfile ? (
          <div 
            ...
            className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 cursor-pointer flex items-center justify-between transition-colors"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-7 h-7 rounded-lg bg-emerald-500/20 text-emerald-400 font-bold flex items-center justify-center text-xs shrink-0">
              ...
              <div className="min-w-0">
                ...
                <span className="text-[10px] text-slate-400 block truncate">
                  {userProfile.plan === 'premium' ? t.premiumPlan : t.freePlan}
                </span>
              </div>
            </div>
          ...
          <button
            onClick={onOpenAuth}
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 text-xs font-semibold text-emerald-400 transition-colors"
          >
